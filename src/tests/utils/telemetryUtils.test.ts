...
suite('Test anonymizeFilePaths', () => {
  ...
  test('should anonymize user paths but preserve node_modules paths', () => {
    ...
    assert.strictEqual(
      result,
      'Error in <REDACTED: user-file-path> and <REDACTED: user-file-path>/node_modules/package/index.js',
    );
  });
  ...
  test('should anonymize file:/ URLs even with JDT workspace paths', () => {
    const input =
      'Failed to read package name from file:/Users/someguy/Library/Application%20Support/Code/User/workspaceStorage/4f4553a7f3f79b5e8qa7c889b39fe96b/redhat.java/jdt_ws/Hello.java/';
    const result = anonymizeFilePaths(input);
  ...
  test('should anonymize user paths but preserve Java paths with default patterns', () => {
    ...
    assert.strictEqual(
      result,
      'Error at <REDACTED: user-file-path>:45 and java.base/java.lang.String.<init>(String.java:123)',
    );
  });
  ...
  test('should not preserve patterns not in custom cleanup patterns', () => {
    ...
    assert.strictEqual(
      result,
      'Error at <REDACTED: user-file-path>:45 and <REDACTED: user-file-path><init>(String.java:123)',
    );
  });
  ...
  test('should handle multiple custom cleanup patterns', () => {
    const input =
      'Error at /Users/john/project/src/main.ts:45, java.base/java.lang.String.<init>(String.java:123), and org.springframework.context.ApplicationContext.getBean(ApplicationContext.java:456)';
  ...
  test('should handle custom cleanup patterns with complex regex', () => {
    const input =
      'Error at /Users/john/project/src/main.ts:45 and my.custom.library/SomeClass.method(SomeClass.java:123)';
    const customPatterns = [/my\.custom\..*/];
    const result = anonymizeFilePaths(input, customPatterns);
    assert.strictEqual(
      result,
      'Error at <REDACTED: user-file-path>:45 and my.custom.library/SomeClass.method(SomeClass.java:123)',
    );
  });

  test('should handle overlapping cleanup patterns', () => {
    const input =
      'Error at /Users/john/project/src/main.ts:45 and java.base/java.util.ArrayList.add(ArrayList.java:123)';
  ...
  test('should preserve node_modules even with custom cleanup patterns', () => {
    const input =
      'Error at /Users/john/project/src/main.ts:45 and /Users/john/project/node_modules/package/index.js:12';
    const customPatterns = [/java\.base\//];
    const result = anonymizeFilePaths(input, customPatterns);
    assert.strictEqual(
      result,
      'Error at <REDACTED: user-file-path>:45 and <REDACTED: user-file-path>/node_modules/package/index.js:12',
    );
  });
  ...
  test('should handle cleanup patterns that match partial paths', () => {
    ...
    assert.strictEqual(
      result,
      'Error at <REDACTED: user-file-path>:45 and some.java.package.Class.method(Class.java:123)',
    );
  });
